        ...
        if(\Auth::user()->can('create overtime'))
        {
            ...
            if ($request->ajax()) {
                return response()->json([
                    'status' => 'success',
                    'message' => __('Overtime successfully created.'),
                    'data' => [
                        'id' => $overtime->id,
                        'title' => $overtime->title,
                        'meta' => $overtime->number_of_days . ' days A- ' . $overtime->hours . 'h A- ' . \Auth::user()->priceFormat($overtime->rate),
                        'amount' => floatval($overtimeTotal),
                        'category' => 'overtime',
                    ],
                ]);
            }
