...
class AllowanceOptionController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('create allowance option'))
        {
            ...
            $allowanceoption->type       = $request->type;
            $allowanceoption->amount     = $request->type != 'range' ? $request->amount : null;
            $allowanceoption->min_amount = $request->type == 'range' ? $request->min_amount : null;
            $allowanceoption->max_amount = $request->type == 'range' ? $request->max_amount : null;
