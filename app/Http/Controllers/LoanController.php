...
class LoanController extends Controller
{
    public function index(Request $request)
    {
        if(\Auth::user()->can('manage loan'))
        {
            ...
            $branches = \App\Models\Branch::where('created_by', \Auth::user()->creatorId())->get()->pluck('name', 'id');
            $departments = \App\Models\Department::where('created_by', \Auth::user()->creatorId())->get()->pluck('name', 'id');
            $designations = \App\Models\Designation::where('created_by', \Auth::user()->creatorId())->get()->pluck('name', 'id');

            return view('loan.index', compact('loans', 'branches', 'departments', 'designations'));
        }
        else
        {
