                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <div class="text-muted">
                                <span class="me-3"><i class="ti ti-id me-1"></i>{{ \Auth::user()->employeeIdFormat($employee->employee_id) }}</span>
                                @if($employee->email)
                                    <span class="me-3"><i class="ti ti-mail me-1"></i>{{ $employee->email }}</span>
                                @endif
                                @if($employee->branch)
                                    <span class="me-3"><i class="ti ti-building me-1"></i>{{ $employee->branch->name }}</span>
                                @endif
                                @if($employee->department)
                                    <span class="me-3"><i class="ti ti-briefcase me-1"></i>{{ $employee->department->name }}</span>
                                @endif
