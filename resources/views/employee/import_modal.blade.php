...
<script>
    $(document).ready(function() {
        ...
        var requiredFields = [
            ...
            'email', 'password', 'company_doj', 'account_holder_name',
            'account_number', 'bank_name', 'bank_identifier_code',
            'branch_location', 'tax_payer_id'
        ];
        ...
        $(document).on('change', '.set_column_data', function() {
            ...
            const missingRequired = requiredFields.filter(function(field) {
                return !(field in column_data);
            });
                ...
                if (missingRequired.length === 0) {
                    ...
                    data = {
                        ...
                        middle_name: column_data.middle_name,
                        ...
                        ssn: column_data.ssn,
                        man_number: column_data.man_number,
                        ...
                        reports_to: column_data.reports_to,
                        branch: [],
                        department: [],
                        designation: []
                    };
