        ...
        <div class="">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    {!! Form::text('first_name', old('first_name'), ['class' => 'form-control', 'required' => 'required', 'placeholder'=>__('Enter first name'), 'id'=>'first_name']) !!}
                                </div>
                                <div class="form-group col-md-4">
                                    {!! Form::label('middle_name', __('Middle Name'), ['class' => 'form-label']) !!}
                                    {!! Form::text('middle_name', old('middle_name'), ['class' => 'form-control', 'placeholder'=>__('Enter middle name'), 'id'=>'middle_name']) !!}
                                </div>
                                <div class="form-group col-md-4">
                                    {!! Form::label('last_name', __('Last Name'), ['class' => 'form-label']) !!}<x-required></x-required>
                                    {!! Form::text('last_name', old('last_name'), ['class' => 'form-control', 'required' => 'required', 'placeholder'=>__('Enter last name'), 'id'=>'last_name']) !!}
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::text('ssn', old('ssn'), ['class' => 'form-control', 'placeholder' => __('Enter SSN')]) !!}
                                </div>
                                <div class="form-group col-md-6">
                                    {!! Form::label('man_number', __('Man Number'), ['class' => 'form-label']) !!}
                                    {!! Form::text('man_number', old('man_number'), ['class' => 'form-control', 'placeholder' => __('Enter Man Number')]) !!}
                                </div>
                            </div>
                            ...
                            <small class="text-muted mt-2" id="full-name-helper">{{ __('Full Name') }} : {{ old('first_name') }} {{ old('middle_name') }} {{ old('last_name') }}</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex">
                        ...
                        <div class="card-body employee-detail-create-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::select('reports_to', $managers->pluck('name','id')->prepend(__('Select Manager'), ''), old('reports_to'), ['class' => 'form-control select', 'placeholder' => __('Select Manager')]) !!}
                                </div>
            ...
            <div class="row mt-3">
                <div class="col-md-12 d-flex">
                    <div class="card em-card w-100">
                        <div class="card-header">
                            <h5>{{ __('Identification') }}</h5>
                        </div>
                        <div class="card-body employee-detail-create-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    {!! Form::label('nrc_number', __('National Registration Card Number'), ['class' => 'form-label']) !!}
                                    {!! Form::text('nrc_number', old('nrc_number'), ['class' => 'form-control', 'placeholder' => __('Enter NRC number')]) !!}
                                </div>
                                <div class="form-group col-md-6">
                                    {!! Form::label('drivers_license_number', __('Driver\'s License Number'), ['class' => 'form-label']) !!}
                                    {!! Form::text('drivers_license_number', old('drivers_license_number'), ['class' => 'form-control', 'placeholder' => __('Enter driver\'s license number')]) !!}
                                </div>
                                <div class="form-group col-md-6">
                                    {!! Form::label('passport_number', __('Passport Number'), ['class' => 'form-label']) !!}
                                    {!! Form::text('passport_number', old('passport_number'), ['class' => 'form-control', 'placeholder' => __('Enter passport number')]) !!}
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('script-page')
    ...
    <script>
        function updateFullName() {
            ...
            $('#full-name-helper').text('{{ __('Full Name') }} : ' + (fullName || '-'));
        }
