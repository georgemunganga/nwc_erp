...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-size="lg" data-url="{{ route('productservice.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-original-title="{{__('Create')}}" title="{{__('Create New Product')}}" class="btn btn-sm btn-primary">
