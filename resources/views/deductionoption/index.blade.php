                        ...
                        <div class="card-body table-border-style">
                            ...
                            <tbody class="font-style">
                                @foreach ($deductionoptions as $deductionoption)
                                    <tr>
                                        <td class="fw-bold">{{ $deductionoption->name }}</td>
                                        <td class="text-capitalize">
                                            {{ $deductionoption->type === 'custom' ? __('Custom tax slabs') : __('Default salary tax slab') }}
                                        </td>
                                        <td>
                                            @if($deductionoption->taxSlabs->isEmpty())
                                                <span class="text-muted small">{{ __('Not assigned') }}</span>
                                            @else
                                                <div class="d-flex flex-wrap gap-1">
                                                    @foreach($deductionoption->taxSlabs as $slab)
