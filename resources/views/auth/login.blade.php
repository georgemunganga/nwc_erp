...
@section('language-bar')
    <div class="lang-dropdown-only-desk d-inline-block">
        <div class="dropdown">
            <a class="btn btn-sm btn-light dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="ti ti-world me-1"></i>{{ $languages[$lang] }}
            </a>
