...
@endphp
@section('content')
    @if(isset($isHRMAdmin) && !$isHRMAdmin)
        <div class="row">
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-xxl-6">
    ...
    @else
        <!-- Modern HRM Dashboard - Horizontal Stats Cards -->
        <div class="modern-dashboard">
            <!-- Primary Stats - Horizontal Scroll on Mobile -->
            <div class="stats-cards-wrapper mb-4">
                <div class="stats-cards-scroll">
                    ...
                    <div class="modern-stat-card">
                        <div class="stat-card-inner">
                            ...
                            <div class="stat-content-modern">
                                <span class="stat-label">{{__('Total Employees')}}</span>
                                <h2 class="stat-value">{{ $totalEmployees ?? 0 }}</h2>
                                <div class="stat-meta">
                                    <span class="meta-badge success">
                                        <i class="ti ti-arrow-up"></i>
                                        {{ $newHiresThisMonth ?? 0 }} {{__('new')}}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modern-stat-card">
                        <div class="stat-card-inner">
                            ...
                            <div class="stat-content-modern">
                                <span class="stat-label">{{__('Present Today')}}</span>
                                <h2 class="stat-value">{{ $presentToday ?? 0 }}</h2>
                                <div class="stat-meta">
                                    <span class="meta-text">
                                        {{ round(($totalEmployees > 0 ? ($presentToday / $totalEmployees) * 100 : 0), 1) }}% {{__('rate')}}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modern-stat-card">
                        <div class="stat-card-inner">
                            <div class="stat-icon-wrap">
                                <div class="stat-icon-modern bg-gradient-danger">
                                    <i class="ti ti-user-x"></i>
                                </div>
                            </div>
                            <div class="stat-content-modern">
                                <span class="stat-label">{{__('Absent Today')}}</span>
                                <h2 class="stat-value">{{ $absentToday ?? 0 }}</h2>
                                <div class="stat-meta">
                                    <span class="meta-badge danger">
                                        {{ $totalOnLeave ?? 0 }} {{__('on leave')}}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modern-stat-card">
                        <div class="stat-card-inner">
                            ...
                            <div class="stat-content-modern">
                                <span class="stat-label">{{__('On Leave')}}</span>
                                <h2 class="stat-value">{{ $totalOnLeave ?? 0 }}</h2>
                                <div class="stat-meta">
                                    <span class="meta-badge warning">
                                        {{ $pendingLeaves ?? 0 }} {{__('pending')}}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modern-stat-card">
                        <div class="stat-card-inner">
                            ...
                            <div class="stat-content-modern">
                                <span class="stat-label">{{__('Departments')}}</span>
                                <h2 class="stat-value">{{ $totalDepartments ?? 0 }}</h2>
                                <div class="stat-meta">
                                    <span class="meta-text">{{ $totalDesignations ?? 0 }} {{__('positions')}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modern-stat-card">
                        <div class="stat-card-inner">
                            <div class="stat-icon-wrap">
                                <div class="stat-icon-modern bg-gradient-purple">
                                    <i class="ti ti-briefcase"></i>
                                </div>
                            </div>
                            <div class="stat-content-modern">
                                <span class="stat-label">{{__('Active Jobs')}}</span>
                                <h2 class="stat-value">{{ $activeJob ?? 0 }}</h2>
                                <div class="stat-meta">
                                    <span class="meta-text">{{ $totalApplications ?? 0 }} {{__('applications')}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card h-100">
                            <div class="card-header">
                                <h5>{{__('Department Distribution')}}</h5>
                            </div>
                            <div class="card-body">
                                            ...
                                            @if($stat->department)
                                                <div class="mb-3">
                                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                                        <span class="text-sm">{{ $stat->department->name }}</span>
                                                        <span class="badge bg-primary">{{ $stat->total }}</span>
                                                    </div>
                                                    <div class="progress" style="height: 8px;">
                                                        <div class="progress-bar bg-primary" role="progressbar"
                                                            style="width: {{ ($totalEmployees > 0 ? ($stat->total / $totalEmployees) * 100 : 0) }}%"></div>
                                                    </div>
                                                </div>
                                            @endif
                                        @endforeach
                                ...
                                @else
                                    <p class="text-muted text-center py-4">{{__('No department data available')}}</p>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="gender-chart">
                                    <div class="row text-center mb-4">
                                        <div class="col-6">
                                            <div class="p-3">
                                                <i class="ti ti-gender-male text-primary" style="font-size: 3rem;"></i>
                                                <h3 class="mt-2 mb-0">{{ $maleEmployees ?? 0 }}</h3>
                                                <p class="text-muted">{{__('Male')}}</p>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="p-3">
                                                <i class="ti ti-gender-female text-danger" style="font-size: 3rem;"></i>
                                                <h3 class="mt-2 mb-0">{{ $femaleEmployees ?? 0 }}</h3>
                                                <p class="text-muted">{{__('Female')}}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="gender-stats">
                                        <div class="mb-2">
                                            <div class="d-flex justify-content-between mb-1">
                                                <span class="text-sm">{{__('Male')}}</span>
                                                <span>{{ round(($totalEmployees > 0 ? ($maleEmployees / $totalEmployees) * 100 : 0), 1) }}%</span>
                                            </div>
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-primary" role="progressbar"
                                                    style="width: {{ ($totalEmployees > 0 ? ($maleEmployees / $totalEmployees) * 100 : 0) }}%"></div>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="d-flex justify-content-between mb-1">
                                                <span class="text-sm">{{__('Female')}}</span>
                                                <span>{{ round(($totalEmployees > 0 ? ($femaleEmployees / $totalEmployees) * 100 : 0), 1) }}%</span>
                                            </div>
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-danger" role="progressbar"
                                                    style="width: {{ ($totalEmployees > 0 ? ($femaleEmployees / $totalEmployees) * 100 : 0) }}%"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card h-100">
                            <div class="card-header">
                                <h5>{{__('Recent Leave Requests')}}</h5>
                            </div>
                            <div class="card-body">
                                @if(isset($recentLeaves) && count($recentLeaves) > 0)
                                    <div class="leave-list">
                                        @foreach($recentLeaves as $leave)
                                            <div class="leave-item mb-3 pb-3 border-bottom">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div>
                                                        <p class="mb-1 fw-bold">{{ $leave->employee->user->name ?? 'N/A' }}</p>
                                                        <p class="text-muted text-sm mb-1">
                                                            <i class="ti ti-calendar"></i>
                                                            {{ \Auth::user()->dateFormat($leave->start_date) }} -
                                                            {{ \Auth::user()->dateFormat($leave->end_date) }}
                                                        </p>
                                                        <p class="text-muted text-sm mb-0">{{ Str::limit($leave->leave_reason, 40) }}</p>
                                                    </div>
                                                    <span class="badge
                                ...
                                @else
                                    <p class="text-muted text-center py-4">{{__('No recent leave requests')}}</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card h-100">
                            <div class="card-header">
                                <h5>{{__('Attendance Analytics (Last 30 Days)')}}</h5>
                            </div>
                            <div class="card-body">
                                <div class="text-center mb-4">
                                    <div class="attendance-circle mx-auto" style="width: 150px; height: 150px; position: relative;">
                                        <svg width="150" height="150">
                                            <circle cx="75" cy="75" r="60" fill="none" stroke="#e9ecef" stroke-width="10"/>
                                            <circle cx="75" cy="75" r="60" fill="none" stroke="#00235a" stroke-width="10"
                                                stroke-dasharray="{{ 2 * 3.14159 * 60 }}"
                                                stroke-dashoffset="{{ 2 * 3.14159 * 60 * (1 - ($attendanceRate ?? 0) / 100) }}"
                                                transform="rotate(-90 75 75)"/>
                                        </svg>
                                        <div class="position-absolute top-50 start-50 translate-middle text-center">
                                            <h2 class="mb-0 fw-bold">{{ $attendanceRate ?? 0 }}%</h2>
                                            <small class="text-muted">{{__('Avg Rate')}}</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="row text-center">
                                    <div class="col-4">
                                        <div class="p-2">
                                            <h5 class="mb-0 text-success">{{ $presentToday ?? 0 }}</h5>
                                            <small class="text-muted">{{__('Present')}}</small>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="p-2">
                                            <h5 class="mb-0 text-warning">{{ $totalOnLeave ?? 0 }}</h5>
                                            <small class="text-muted">{{__('On Leave')}}</small>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="p-2">
                                            <h5 class="mb-0 text-danger">{{ $absentToday ?? 0 }}</h5>
                                            <small class="text-muted">{{__('Absent')}}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card h-100">
                            <div class="card-header">
                                <h5>{{__('Quick Insights')}}</h5>
                            </div>
                            <div class="card-body">
                                <div class="quick-insights">
                                    <div class="insight-item d-flex align-items-center mb-3 p-3 bg-light rounded">
                                        <div class="insight-icon me-3">
                                            <i class="ti ti-user-plus text-success" style="font-size: 2rem;"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 text-muted">{{__('New Hires This Month')}}</p>
                                            <h4 class="mb-0">{{ $newHiresThisMonth ?? 0 }}</h4>
                                        </div>
                                    </div>

                                    <div class="insight-item d-flex align-items-center mb-3 p-3 bg-light rounded">
                                        <div class="insight-icon me-3">
                                            <i class="ti ti-cake text-warning" style="font-size: 2rem;"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 text-muted">{{__('Upcoming Birthdays (Next 7 Days)')}}</p>
                                            <h4 class="mb-0">{{ $upcomingBirthdays ?? 0 }}</h4>
                                        </div>
                                    </div>

                                    <div class="insight-item d-flex align-items-center mb-3 p-3 bg-light rounded">
                                        <div class="insight-icon me-3">
                                            <i class="ti ti-file-alert text-danger" style="font-size: 2rem;"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 text-muted">{{__('Documents Expiring (Next 30 Days)')}}</p>
                                            <h4 class="mb-0">{{ $expiringDocuments ?? 0 }}</h4>
                                        </div>
                                    </div>

                                    <div class="insight-item d-flex align-items-center p-3 bg-light rounded">
                                        <div class="insight-icon me-3">
                                            <i class="ti ti-clock text-info" style="font-size: 2rem;"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 text-muted">{{__('Pending Leave Approvals')}}</p>
