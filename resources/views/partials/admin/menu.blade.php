...
<div class="navbar-wrapper">
    <div class="m-header main-logo">
        <a href="#" class="b-brand">
                ...
                <img src="{{ !empty($company_logos) ? $logo . '/' . $company_logos : asset('assets/images/logo-light.png') }}"
                    alt="{{ config('app.name', 'Amizo') }}" class="logo w-100 logo-lg">
    ...
    <div class="navbar-content">
        @if (\Auth::user()->type != 'client')
            <ul class="dash-navbar">
                ...
                <!--------------------- Start Dashboard (Direct Parent Items) ----------------------------------->

                @if ($show_dashboard == 1 && Gate::check('show account dashboard'))
                    <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == null || Request::segment(1) == 'report' || Request::segment(1) == 'reports-monthly-cashflow' || Request::segment(1) == 'reports-quarterly-cashflow' || Request::segment(1) == 'account-statement-report' || Request::segment(1) == 'invoice-summary' || Request::segment(1) == 'sales' || Request::segment(1) == 'receivables' || Request::segment(1) == 'payables' || Request::segment(1) == 'bill-summary' || Request::segment(1) == 'product-stock-report' || Request::segment(1) == 'transaction' || Request::segment(1) == 'income-summary' || Request::segment(1) == 'expense-summary' || Request::segment(1) == 'income-vs-expense-summary' || Request::segment(1) == 'tax-summary' ? ' active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link" data-title="{{ __('Accounting Dashboard') }}">
                            ...
                            @if (Gate::check('income report') ||
                                ...
                                <li
                                    class="dash-item dash-hasmenu
                                            {{ Request::segment(1) == 'report' || Request::segment(1) == 'reports-monthly-cashflow' || Request::segment(1) == 'reports-quarterly-cashflow' || Request::segment(1) == 'account-statement-report' || Request::segment(1) == 'invoice-summary' || Request::segment(1) == 'sales' || Request::segment(1) == 'receivables' || Request::segment(1) == 'payables' || Request::segment(1) == 'bill-summary' || Request::segment(1) == 'product-stock-report' || Request::segment(1) == 'transaction' || Request::segment(1) == 'income-summary' || Request::segment(1) == 'expense-summary' || Request::segment(1) == 'income-vs-expense-summary' || Request::segment(1) == 'tax-summary' ? 'active dash-trigger ' : '' }}">
                ...
                @if ($show_dashboard == 1)
                    @can('show hrm dashboard')
                        <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'hrm-dashboard' || Request::segment(1) == 'reports-payroll' || Request::segment(1) == 'report-leave' || Request::segment(1) == 'reports-monthly-attendance' ? ' active dash-trigger' : '' }}">
                            <a href="#!" class="dash-link" data-title="{{ __('HRM Dashboard') }}">
                ...
                @if ($show_dashboard == 1)
                    @can('show crm dashboard')
                        <li
                            ...
                            <a href="#!" class="dash-link" data-title="{{ __('CRM Dashboard') }}">
                                <span class="dash-micon"><i class="ti ti-brand-chrome"></i></span>
                ...
                @if ($show_dashboard == 1)
                    @can('show project dashboard')
                        <li
                            ...
                            <a class="dash-link" href="{{ route('project.dashboard') }}" data-title="{{ __('Project Dashboard') }}">
                ...
                @if ($show_dashboard == 1)
                    @can('show pos dashboard')
                        <li
                            ...
                            <a href="#!" class="dash-link" data-title="{{ __('POS Dashboard') }}">
                ...
                @endif
                        ...
                        @if (Gate::check('manage employee') ||
                            ...
                            <li
                                ...
                                Request::segment(1) == 'loanoption' || Request::segment(1) == 'deductionoption'
                                    ? 'active dash-trigger'
                                    : '' }}">
                                <a href="#!" class="dash-link " data-title="{{ __('HRM System') }}"><span class="dash-micon"><i
                                    ...
                                    @if (Gate::check('manage set salary') || Gate::check('manage pay slip'))
                                        <li class="dash-item dash-hasmenu  {{ Request::segment(1) == 'setsalary' || Request::segment(1) == 'payslip' ? 'active dash-trigger' : '' }}">
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                @can('manage set salary')
                                                    <li
                                                        class="dash-item {{ request()->is('setsalary/bulk') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('setsalary.bulk') }}">{{ __('Bulk salary assignment') }}</a>
                                                    </li>
                                                @endcan
                                                @can('manage set salary')
                                                    <li
                                                        class="dash-item {{ request()->is('taxslab*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('taxslab.index') }}">{{ __('Tax Slabs') }}</a>
                                                    </li>
                                                @endcan
                                                @can('manage pay slip')
                                                    <li
                        ...
                        @if (Gate::check('manage budget plan') || Gate::check('income vs expense report') ||
                            ...
                            <li
                                ...
                                Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note' || (Request::route()->getName() == 'report.balance.sheet') || (Request::route()->getName() == 'trial-balance-report') ? ' active dash-trigger'
                                    : '' }}">
                                <a href="#!" class="dash-link" data-title="{{ __('Accounting System') }}"><span class="dash-micon"><i
                    ...
                    @if ($show_dashboard == 1)
                        @if (Gate::check('manage lead') ||
                            ...
                            <li
                                ...
                                <a href="#!" class="dash-link" data-title="{{ __('CRM System') }}"><span class="dash-micon"><i
                        ...
                        @if (Gate::check('manage project') || Gate::check('manage project task') ||
                            ...
                            <li
                                ...
                                Request::segment(1) == 'project_report'
                                    ? 'active dash-trigger'
                                    : '' }}">
                                <a href="#!" class="dash-link" data-title="{{ __('Project System') }}"><span class="dash-micon"><i
                    ...
                    @if ( \Auth::user()->type != 'super admin' &&
                        ...
                        <li
                            ...
                            Request::segment(1) == 'userlogs'
                                ...
                                : '' }}">
                            <a href="#!"
                                class="dash-link {{ Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients' ? ' active dash-trigger' : '' }}" data-title="{{ __('User Management') }}"><span
                    ...
                    @if (Gate::check('manage product & service'))
                        <li class="dash-item dash-hasmenu">
                            <a href="#!" class="dash-link " data-title="{{ __('Products System') }}">
                    ...
                    @if($show_dashboard == 1)
                        @if (Gate::check('manage warehouse') ||
                            ...
                            <li
                                ...
                                <a href="#!" class="dash-link" data-title="{{ __('POS System') }}"><span class="dash-micon"><i
                                            class="ti ti-layers-difference"></i></span><span
                    ...
                    @if (\Auth::user()->type == 'company')
                        <li
                            ...
                            <a href="#!" class="dash-link" data-title="{{ __('Templates') }}"><span class="dash-micon"><i
