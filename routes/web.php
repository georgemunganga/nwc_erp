...
Route::post('employee/{id}/toggle-login', [EmployeeController::class, 'toggleLogin'])->name('employee.toggle.login')->middleware(['auth', 'XSS']);
...
Route::get('setsalary/bulk', [SetSalaryController::class, 'bulk'])->name('setsalary.bulk')->middleware(['auth', 'XSS']);
Route::post('setsalary/apply-allowances', [SetSalaryController::class, 'applyAllowances'])->name('setsalary.apply-allowances')->middleware(['auth', 'XSS']);
Route::post('setsalary/apply-deductions', [SetSalaryController::class, 'applyDeductions'])->name('setsalary.apply-deductions')->middleware(['auth', 'XSS']);
...
Route::post('payslip/apply-components', [PaySlipController::class, 'applyComponents'])->name('payslip.apply-components')->middleware(['auth', 'XSS']);
...
Route::resource('taxslab', TaxSlabController::class)->middleware(['auth', 'XSS'])->except(['show']);
